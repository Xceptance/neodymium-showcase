...
public class NeodymiumLocalProxyBasicAuthenticationHostTest extends AbstractTest
{
     ...
     * approach. All requests are routed through the Local Proxy running in the Neodymium test execution processas as
     * configured at runtime. This enables to use different hosts in the test suite. The Neodymium Local Proxy adds the
