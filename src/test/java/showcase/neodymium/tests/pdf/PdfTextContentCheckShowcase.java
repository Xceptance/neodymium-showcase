...
public class PdfTextContentCheckShowcase extends AbstractTest
{
     ...
     * Neodymium is implemented in Java based on Maven any available 3rd party technology can be added to the test
     * automation. This show case gives an basic example how to implement an PDF content check using pdfbox.
     * 
     * REQUIRED CONFIGURATION
     * 
     * pom.xml: - org.apache.pdfbox must be added to the dependencies section
     * 
     */
