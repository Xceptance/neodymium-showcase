 ...
 * has the same name as the test case and is located in the same package in the resources folder.<br> This example shows the reading from a CSV file, although a
 * matching JSON file exists.<br> The CSV file is taken in preference to XML and JSON.<br> The use of the method Neodymium.dataValue() is shown here.
 */
...
public class DataFilePriorityTest extends AbstractTest
{
    ...
    public void test()
    {
        ...
        $("#introduction h1").should(matchText(Neodymium.dataValue("teaserMessage")));
        $("#introduction p").should(matchText(Neodymium.dataValue("teaserComment")));
    }
}
