...
public class NeodymiumLocalizationShowcase extends AbstractTest {
  /*
   * Most systems under test offer different languages in their front ends that the test 
   * ware needs to deal with. Localized content might be subject of the test. Neodymium offers 
   * a basic way to handle this. This show case provides possible approaches how to use the 
   * Neodymium localization.
   * 
   * REQUIRED CONFIGURATION
   * 
   * config/localization.yaml:
   * - YAML structured content to be used
   * - upmost element is taken as the Neodymium locale
